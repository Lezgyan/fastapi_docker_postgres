...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["department_id"], [f"{settings.POSTGRES_SCHEMA}.departments.department_id"],
    ...
    op.create_table(
        ...
        sa.Column('department_id', sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(['position_id'], [f'{settings.POSTGRES_SCHEMA}.positions.position_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['department_id'], [f'{settings.POSTGRES_SCHEMA}.departments.department_id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['patient_id'], [f'{settings.POSTGRES_SCHEMA}.patients.patient_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['disease_id'], [f'{settings.POSTGRES_SCHEMA}.diseases.disease_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['doctor_id'], [f'{settings.POSTGRES_SCHEMA}.doctors.doctor_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['ward_id'], [f'{settings.POSTGRES_SCHEMA}.ward.id'], ondelete='CASCADE', onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.Column('doctor_id', sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(['history_id'], [f'{settings.POSTGRES_SCHEMA}.medical_history.history_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['doctor_id'], [f'{settings.POSTGRES_SCHEMA}.doctors.doctor_id'], ondelete='CASCADE', onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['history_id'], [f'{settings.POSTGRES_SCHEMA}.medical_history.history_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['doctor_id'], [f'{settings.POSTGRES_SCHEMA}.doctors.doctor_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['operation_type_id'], [f'{settings.POSTGRES_SCHEMA}.operation_types.operation_type_id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['course_of_treatment_id'], [f'{settings.POSTGRES_SCHEMA}.course_of_treatment.id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['medication_id'], [f'{settings.POSTGRES_SCHEMA}.medicine.id'], ondelete='CASCADE', onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['doctor_id'], [f'{settings.POSTGRES_SCHEMA}.doctors.doctor_id'], ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['qualification_id'], [f'{settings.POSTGRES_SCHEMA}.qualification_type.id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['operation_type_id'], [f'{settings.POSTGRES_SCHEMA}.operation_types.operation_type_id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['qualification_type_id'], [f'{settings.POSTGRES_SCHEMA}.qualification_type.id'], ondelete='CASCADE',
                                onupdate='CASCADE'),
        schema=settings.POSTGRES_SCHEMA
    )
